...
(function() {
  var BLACK, City, MAX_BLUE, MAX_GREEN, MAX_RED, MEDIUM_GREEN, MIN_BLUE, MIN_GREEN, MIN_RED, MONTHNAMES, WHITE, colorToHtml, getColor, global, gradient, loadCitiesFromJson, loadStatsFromJson, prevNextClick, refreshCities, rgb2hex, updateCitiesMonth, updateMeteoTables,
  ...
  City = (function() {
    ...
    City.prototype.addToTable = function() {
      var btn, code, container, data, header, month, stat_infos, table, tr, value, _i, _ref;
      ...
      for (code in _ref) {
        ...
        $('<th>').html("" + stat_infos['name'] + " (" + stat_infos['unit'] + ")").appendTo(tr);
  ...
  loadCitiesFromJson = function(jsonData) {
    ...
    while (true) {
      ...
      if (!(old_id != null) && !(new_id != null)) {
        ...
        global.cities[new_id] = new City(infos.name, infos.coords, infos.month_stats);
